...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Process and analyze cortisol data",
    Description = "Reformat and analyze cortisol data from Devore",
    `Authors@R` = c(
      person("Ken", "Butler", email = "ken@swiss-soccer.net", role = c("aut", "cre"), comment = c(ORCID = "0000-0001-7821-6811"))
    )
  ),
  overwrite = TRUE
)
...
make the dataset and put it in inst
...
data("ex15.25")
births <- ex15.25
write_csv(births, here::here("inst", "births.csv"))
```
